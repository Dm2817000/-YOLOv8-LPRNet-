...
def get_parser():
    ...
    # 设置你的数据集路径
    parser.add_argument('--train_img_dirs', default=r"E:/translation/LPRNET_train_processed_mini/train", 
                        help='the train images path')
    parser.add_argument('--test_img_dirs', default=r"E:/translation/LPRNET_train_processed_mini/val", 
    ...
    # 调整学习率计划（更早开始降低学习率）
    parser.add_argument('--lr_schedule', default=[3, 6, 9, 12, 15], help='schedule for learning rate.')
    
    parser.add_argument('--save_folder', default='./weights/', help='Location to save checkpoint models')
    parser.add_argument('--pretrained_model', default='', help='pretrained base model')

    args = parser.parse_args()
    # 在train_LPRNet.py的train()函数开头添加：
